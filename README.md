...
| Project | Description |
|----------|-------------|
| 💳 Credit Risk Prediction | Predict customer creditworthiness using Machine Learning and React.JS |
|📉 Customer Churn Prediction | Developed end-to-end customer churn prediction dashboard using Streamlit, MongoDB|
